...
public class ModuleIOSim implements ModuleIO {
    ...
    //private FlywheelSim testSim = new FlywheelSim(LinearSystemId.createFlywheelSystem(DCMotor.getNEO(1), 1,1), 6.12, 0.025);
    //private FlywheelSim test2sim = new FlywheelSim(LinearSystemSim<1,1,1>, 6.12, 0.025);
