...
public class ModuleIOSpark implements ModuleIO {
  ...
  private final RelativeEncoder
      turnEncoder; // changed from AbsoluteEncoder to RelativeEncoder since we are using CANcoders
  // for turning

  private CANcoder customEncoder;
  ...
  public ModuleIOSpark(int module) {
    ...
    turnEncoder =
        turnSpark.getEncoder(); // changed from getAbsoluteEncoder to getEncoder since we are using
    // CANcoders for turning
    ...
    turnConfig
        ...
        .feedbackSensor(
            FeedbackSensor
                .kPrimaryEncoder) // changed from kAbsoluteEncoder to kPrimaryEncoder since we are
        // using CANcoders for turning
    ...
    tryUntilOk(
        ...
        () ->
            turnEncoder.setPosition(
                customEncoder.getAbsolutePosition().getValueAsDouble() * 2.0 * Math.PI));
